...
echo "================================"
echo "filipmercep Django Deployment"
echo "================================"
...
if [ ! -f "$PROJECT_DIR/.env" ]; then
    ...
    echo ""
    echo "IMPORTANT: Edit /var/www/filipmercep/.env and configure:"
...
if [ "$setup_ssl" = "y" ]; then
    ...
    sudo certbot --nginx -d filipmercep.vumgames.com --non-interactive --agree-tos --email $email --redirect
    ...
    if [ $? -eq 0 ]; then
        ...
        echo "sudo certbot --nginx -d filipmercep.vumgames.com"
    fi
else
...
if [ "$setup_ssl" = "y" ]; then
    echo "  https://filipmercep.vumgames.com"
    echo "  Admin panel: https://filipmercep.vumgames.com/admin/"
else
    echo "  http://filipmercep.vumgames.com (HTTP only - setup SSL for HTTPS)"
    echo "  Admin panel: http://filipmercep.vumgames.com/admin/"
fi
echo ""
